...
ADMIN = int(environ.get('ADMIN', '5657408797'))
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002811002365'))
...
LINK_URL = environ.get("LINK_URL", "https://itopupflix.blogspot.com/p/itopupflix-watching-online.html")
